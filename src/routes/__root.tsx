...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "EduInsight AI — Student Performance Analytics" },
      { name: "twitter:title", content: "EduInsight AI — Student Performance Analytics" },
      { property: "og:description", content: "AI-powered platform to analyze, predict and improve student academic performance." },
      { name: "twitter:description", content: "AI-powered platform to analyze, predict and improve student academic performance." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ecb6ee31-1b86-47fd-9e9d-59e53ff9bb8c/id-preview-09c4737e--6065fdbe-3188-4a06-8cdf-4cdc43bee123.lovable.app-1778640135031.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ecb6ee31-1b86-47fd-9e9d-59e53ff9bb8c/id-preview-09c4737e--6065fdbe-3188-4a06-8cdf-4cdc43bee123.lovable.app-1778640135031.png" },
